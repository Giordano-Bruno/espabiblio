...
#FIX JALG --- 03-2015
#FIX poner funcion de validacion o prueba similar a el de UPLOAD MARC
...
<form method="post" enctype="multipart/form-data" action="<?php echo $_SERVER["SCRIPT_NAME"]; ?>">
  ...
  <input type="hidden" name="MAX_FILE_SIZE" value="<?php echo OBIB_MAX_FILE_SIZE; //JALG 3-2015?>"/>

        ...
        if ($marcTags != false) {
          foreach($marcTags as $tagKey => $tag) {
            ...
            if (strcmp($selectedTag,$tagKey) == 0) {
              ...
              <a href="../catalog/marc_select.php?block=<?php echo HURL($blockKey); ?>" class="nav">
              -&nbsp;</a>
...
<!-- 
 ...
 -->                  
              ...
              <tr><td class="noborder"></td>
              <td class="noborder">
              <a href="../catalog/marc_select.php?block=<?php echo HURL($blockKey); ?>&amp;tag=<?php echo HURL($tagKey); ?>" class="nav">
              +</a>

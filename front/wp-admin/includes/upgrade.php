...
//jalg 02022013
	...
	$default_links[] = array(	'link_url' => get_option('home') . '/../admin',
								'link_name' => 'Administración de la Biblioteca',
								'link_rss' => '',
								'link_notes' => '');
//jalg 02022013	
...
//jalg 02022013
  ...
  // Enable default plugins & widgets.
	...
	$wpdb->insert( $wpdb->options, array(	'option_name' => 'widget_obopac-widget',
								'option_value' => 'a:2:{i:1;a:0:{}s:12:"_multiwidget";i:1;}'
								));
	$wpdb->insert( $wpdb->options, array(	'option_name' => 'widget_pages',
								'option_value' => 'a:2:{i:1;a:3:{s:5:"title";s:0:"";s:6:"sortby";s:10:"post_title";s:7:"exclude";s:3:"3,4";}s:12:"_multiwidget";i:1;}'
								));
	$wpdb->insert( $wpdb->options, array(	'option_name' => 'widget_archives',
								'option_value' => 'a:2:{i:1;a:3:{s:5:"title";s:0:"";s:5:"count";i:0;s:8:"dropdown";i:0;}s:12:"_multiwidget";i:1;}'
								));
	$wpdb->update( $wpdb->options, array(	'option_value' => 'a:2:{i:1;a:4:{s:5:"title";s:0:"";s:5:"count";i:0;s:12:"hierarchical";i:0;s:8:"dropdown";i:0;}s:12:"_multiwidget";i:1;}'),
								array('option_name' => 'widget_categories') );
	$wpdb->insert( $wpdb->options, array(	'option_name' => 'widget_links',
	...
	$wpdb->insert( $wpdb->options, array(	'option_name' => 'widget_meta',
								'option_value' => 'a:2:{i:1;a:1:{s:5:"title";s:0:"";}s:12:"_multiwidget";i:1;}'
								));
	$wpdb->insert( $wpdb->options, array(	'option_name' => 'sidebars_widgets',
	...
	$wpdb->insert( $wpdb->options, array(	'option_name' => 'obopac_api_path',

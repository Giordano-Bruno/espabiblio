...
//echo $path;
     ?>
          <p><label for="<?php echo $this->get_field_id('api_path'); ?>">
	    <?php _e('OpenBiblio Path:'); ?> 
	    <input class="widefat" id="<?php echo $this->get_field_id('api_path'); ?>" name="<?php echo $this->get_field_name('api_path'); ?>" type="text" value="<?php echo $path; ?>" />
	  </label></p>
...
echo <<<INNERHTML
		<h3 class="widget-title">Catalogo Público</h3>

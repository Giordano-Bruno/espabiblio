...
$trans["adminStaff_Return"]   = "\$text = 'Tornare all\'amministrazione dei tesserati';";

#****************************************************************************
#*  Translation text for page index.php
#****************************************************************************
$trans["indexHeading"]            = "\$text='Prestito';";
$trans["indexCardHdr"]            = "\$text='Ricerca per numero di tessera:';";
$trans["indexCard"]               = "\$text='Numero di tessera:';";
$trans["indexSearch"]             = "\$text='Ricerca';";
$trans["indexNameHdr"]            = "\$text='Ricerca per cognome:';";
...
#****************************************************************************
$trans["MailingAddress:"] = "\$text='Indirizzo posta:';";
...
$trans["mbrFldsSubmit"]           = "\$text='Invio';";
...
$trans["Seleccione_Foto"]        = "\$text='Selezione file Foto: </br>*Sarà copiato automaticamente in ../media/lector';";

#****************************************************************************
#*  Translation text for page mbr_new.php
#****************************************************************************
$trans["mbrNewSuccess"]           = "\$text='Socio aggiunto alla base dei dati correttamente.';";
...
#****************************************************************************
$trans["mbrViewHead1"]            = "\$text='Informazioni di tesserati:';";
...
$trans["mbrViewHead2"]            = "\$text='Storico del Prestito:';";
...
$trans["mbrViewOutHdr10"]         = "\$text='Registrarsi';";
$trans["To Shelving Cart"]        = "\$text='Al carrello dei materiali da riporre sugli scaffali';";
...
$trans["mbrViewNoHolds"]          = "\$text='Non ci sono bibliografie attualmente in attesa.';";
$trans["mbrViewBalMsg"]           = "\$text='Nota: il tesserato ha un conto in sospeso di %bal%.';";
$trans["mbrPrintCheckouts"]	    = "\$text='Stampa prestiti';";
$trans["mbrViewDel"]              = "\$text='canc';";
...
$trans["mbrViewStatColHdr5"]      = "\$text='Rinnovare';";
$trans["mbrViewStatus"]           = "\$text='Stato:';";

#****** jalg,  Modificado para mostrar imagen de usuario
$trans["mbrViewHead8"]            = "\$text='Immagine tesserato:';";
$trans["mbrViewFotHdr1"]          = "\$text='File della Foto';";
$trans["mbrViewHead_foto"]            = "\$text='immagine:';";//debug
#****** jalg,  Modificado para mostrar imagen de usuario
...
$trans["Reset pass"]				= "\$text = 'Cambiare password ';";
$trans["member_list_Pwd"]			= "\$text = 'N. di tessera: ';";
$trans["loginFormPassword"]			= "\$text = 'Password';";
$trans["indexHeadingUser"]			= "\$text = 'Consultazione stato tesserato';";
$trans["loginFormLogin"]			= "\$text = 'Ingresso';";

#* user_pwd-reset 
$trans["adminStaff_pwd_reset_form_Resetheader"]			= "\$text = 'Cambiare la password';";
$trans["adminStaff_new_form_Reenterpassword"]			= "\$text = 'Confirmare la password';";
$trans["adminStaff_new_form_Password"]			= "\$text = 'Nuova chiave di accesso';";
$trans["adminCancel"]			= "\$text = 'Cancellare';";
$trans["adminSubmit"]			= "\$text = 'Accettare';";

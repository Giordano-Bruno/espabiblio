...
$trans["indexCircDesc4"]		= "\$text='Registros de bibliografía y del carro de reposición en estantería';";
...
$trans["indexGenDesc5"]			= "\$text='/api. de openbiblio genérica';";
$trans["indexGenDesc6"]			= "\$text='/cron. Proporciona funciones de para sincronizar y cronometro';";

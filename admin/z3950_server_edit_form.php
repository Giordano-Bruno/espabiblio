...
//jalg para corregir bug de selecotr de uso de servidor
...
<table class="primary">
  <tr>
    <th align="left" colspan="2" valign="top">
      <?php if ($postVars['name']) { echo $loc->getText("lookup_hostsEditHeader"); 
	} else { 
		echo $loc->getText("lookup_hostsNewHeader"); } ?>
    </th>
  </tr>
  <tr>
    <td class="primary">
  ...
  <tr>
    <td class="primary" valign="top">
      <label for="active"><?php echo $loc->getText("lookup_hostsActive"); ?>
	</label>
    </td>
  ...
  <tr>
    ...
    <td class="primary"><?php printMyInputText("charset",10,20,$postVars,$pageErrors); ?> 
	<font class="small"><?php echo $loc->getText('lookup_DefaultCharset'); ?></font></td>
  </tr>
  <tr>
    <td class="primary">&nbsp;</td>
	...
	<input type="button" class="button" value="  <?php echo $loc->getText('adminCancel'); ?>  " onclick="self.location='../admin/z3950_server_list.php'">
    </td>
  </tr>

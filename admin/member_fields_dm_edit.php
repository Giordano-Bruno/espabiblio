 ...
 */
  ...
  if (count($_POST) == 0) {
    header("Location: ../admin/member_fields_dm_list.php");
    exit();
  }
  ...
  if (!$dm->validateData()) {
    ...
    header("Location: ../admin/member_fields_dm_edit_form.php");
    exit();
  }
...
<a href="../admin/member_fields_dm_list.php"><?php echo $loc->getText("return to member field list"); ?></a>
